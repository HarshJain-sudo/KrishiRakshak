    ...
    <Box className='findFreinds'>
        ...
        <Container>
            <Box className='FriendsContainer'>
                <Typography variant='h5'>Find Farmers </Typography>
                        ...
                        <Grid item xs={4} md={2}>
                            <Box className='friend' display='flex' flexDirection='column' >
                                ...
                                <Box className='info'>
                                    ...
                                    <Button fullWidth variant='contained' color='' className={UserGState.info.following&&UserGState.info.following.includes(user._id)&&"unfollow"} onClick={() => AddFriend(user._id)}>
